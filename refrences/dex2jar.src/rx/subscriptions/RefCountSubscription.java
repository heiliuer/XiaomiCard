  ...
  implements Subscription
{
  ...
  public Subscription get()
  {
    ...
    {
      return localObject;
      if (!localAtomicReference.compareAndSet(localState, localState.addChild()))
        break;
    }
  }
  ...
  {
    AtomicReference localAtomicReference = this.state;
    State localState1 = (State)localAtomicReference.get();
    if (localState1.isUnsubscribed);
    while (true)
    {
      return;
      State localState2 = localState1.unsubscribe();
      if (!localAtomicReference.compareAndSet(localState1, localState2))
        break;
  ...
  private static final class InnerSubscription extends AtomicInteger
    implements Subscription
  {
