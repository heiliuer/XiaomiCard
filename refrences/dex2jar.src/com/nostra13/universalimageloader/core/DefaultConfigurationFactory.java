...
public class DefaultConfigurationFactory
{
  ...
  public static DiskCache createDiskCache(Context paramContext, FileNameGenerator paramFileNameGenerator, long paramLong, int paramInt)
  {
    ...
    if ((paramLong > 0L) || (paramInt > 0))
      localFile2 = StorageUtils.getIndividualCacheDirectory(paramContext);
    while (true)
    {
      try
      {
        localObject = new LruDiskCache(localFile2, localFile1, paramFileNameGenerator, paramLong, paramInt);
        return localObject;
      }
      ...
      Object localObject = new UnlimitedDiskCache(StorageUtils.getCacheDirectory(paramContext), localFile1, paramFileNameGenerator);
    }
  }
