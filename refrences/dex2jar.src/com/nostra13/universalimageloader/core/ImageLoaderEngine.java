...
class ImageLoaderEngine
{
  ...
  {
    this.taskDistributor.execute(new Runnable(paramLoadAndDisplayImageTask)
    {
      public void run()
      {
        File localFile = ImageLoaderEngine.this.configuration.diskCache.get(this.val$task.getLoadingUri());
        int i;
        ...
        while (true)
        {
          ...
          i = 0;
          break;
          label69: ImageLoaderEngine.this.taskExecutor.execute(this.val$task);
        }
      }
    });
  }
