...
public final class ImageLoaderConfiguration
{
    ...
    implements ImageDownloader
  {
    ...
    public InputStream getStream(String paramString, Object paramObject)
      throws IOException
    {
      Object localObject = this.wrappedDownloader.getStream(paramString, paramObject);
      ...
      {
        return localObject;
        localObject = new FlushedInputStream((InputStream)localObject);
      }
    }
  }
  ...
  public static class Builder
  {
    ...
    private void initEmptyFieldsWithDefaultValues()
    {
      ...
      while (true)
      {
        ...
        break;
        label202: this.customExecutorForCachedImages = true;
      }
    }
